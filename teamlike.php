...
\033[1;33m\t╔♫════════════════════════════════════════♫═╗
\t$syan        ☞ 𝕐𝕆𝕌𝕋𝕌𝔹𝔼: VUICLIP.CF
\t$yellow        ☞ ℤ𝔸𝕃𝕆: 0948399159
\t$hong        ☞ Tsr: TYPRO
\t$green        ☞ Facebook: typro102
...
switch ($d) {
case "Sun":
$password = "05055Ufcucuf58";
break;
case "Mon":
$password = "58686ugxgxuuguxg788";
break;
case "Tue":
$password = "53838ucffuucg3838";
break;
case "Wed":
$password = "53838xfxuxfucuggcu2735";
break;
case "Thu":
$password = "5275455fcuucufccfu555";
break;
case "Fri":
$password = "282727fxxfu7272";
break;
case "Sat":
$password = "558382ufzufzux5580";
break;
default:
$password = "8386828guxgfu5858";
break;
}
...
switch ($d) {
case "Sun":
$linkpassword = "https://pastebin.com/raw/Z43ZEKSD";
break;
case "Mon":
$linkpassword = "https://pastebin.com/raw/HAH2TYYG";
break;
case "Tue":
$linkpassword = "https://pastebin.com/raw/XE4Mk1Pf";
break;
case "Wed":
$linkpassword = "https://pastebin.com/raw/WgyTa9B4";
break;
case "Thu":
$linkpassword = "https://pastebin.com/raw/pjUXULmF";
break;
case "Fri":
$linkpassword = "https://pastebin.com/raw/K3NDst59";
break;
case "Sat":
$linkpassword = "https://pastebin.com/raw/N5a3uVqY";
break;
default:
$linkpassword = "https://pastebin.com/raw/2wrX2sUU";
break;
}
$api_token = 'f52a9f755cedebd2dbcb8fd0e501bc4b4931df7e';
$api_url = "https://link1s.com/api?api={$api_token}&url={$linkpassword}";
...
$lock=file_get_contents('https://pastebin.com/raw/M7EaKcYz');
...
if (md5('lock') != $keylock) {
	...
	echo $syan."\033[1;34m[\033[1;36mZalo\033[1;34m]⇒ \033[1;32m0948399159\n".$red;
	echo $syan."\033[1;34m[\033[1;36mFacebook\033[1;34m]⇒ \033[1;33mtypro102\n".$red;
exit($red."Vui Lòng Liên Hệ \033[1;35m☛TYPRO☚ \033[1;31mĐể Lấy Tool Mới Nhé !!\n".$red);
}
sleep(1); 
echo "\033[1;92m=================================================\n";
echo "\033[0;37mCopy Links:\033[1;35m[\033[1;33m ".$result["shortenedUrl"]."\033[1;35m ]\n";
echo "\033[1;92m=================================================\n";

echo "\033[1;97m ~\033[1;91m[\033[1;92mPASSWORD\033[1;91m] \033[1;97m=> \033[90m";
